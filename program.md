...
| `engine.py`       | NO        | Chess engine implementation (Sunfish core).       |
...
- No edits to `engine.py`'s core search/move-gen algorithms.
- No edits to `evaluator.py`. The evaluation protocol is locked (see README).
